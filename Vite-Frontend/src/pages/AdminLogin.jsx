...
const AdminLogin = () => {
  return (
    <div className="pt-25 bg-gray-50 flex flex-col justify-center py-1 sm:px-3 lg:px-1">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900">GameStart</h2>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  placeholder="admin@gamestart.com"
                />
              </div>
            </div>
